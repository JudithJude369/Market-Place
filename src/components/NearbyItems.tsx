...
const NearbyItems = () => {
  return (
    <section className="flex flex-col gap-4 lg:pt-20 items-start px-6 ">
      ...
      <article className="flex gap-2 lg:gap-8 ">
        <div className="flex items-center flex-col gap-1">
          <div className="p-2 lg:p-3 shadow rounded-4xl bg-gray-300">
            <MdOutlineChair className="text-2xl lg:text-4xl" />
          </div>
        ...
        <div className="flex items-center flex-col gap-1">
          <div className="p-2 lg:p-3 shadow rounded-4xl bg-gray-300">
            <MdOutlinePhoneIphone className="text-2xl lg:text-4xl" />
          </div>
        ...
        <div className="flex items-center flex-col gap-1">
          <div className="p-2 lg:p-3 shadow rounded-4xl bg-gray-300">
            <FaCarSide className="text-2xl lg:text-4xl" />
          </div>
        ...
        <div className="flex items-center flex-col gap-1">
          <div className="p-2 lg:p-3 shadow rounded-4xl bg-gray-300">
            <IoHome className="text-2xl lg:text-4xl" />
          </div>
